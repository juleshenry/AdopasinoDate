...
contract Tstcont {
    ...
    function getCnt() public view returns(uint8) {
        return cnt;
    }

    function setCnt(uint8 number) public {
        cnt = number;
    }
}
...
contract Factory {
    ...
    */
    function createReceiver(uint256 recCount) public {
        ...
        receiversMap[recCount] = new Receiver();
    ...
    /*
        ...
        @return true if transfer succeeded, false otherwise
    */
    function sendFundsFromReceiversTo( uint256[] IDs, address tracker, uint256[] amounts, uint256[] receivers ) public {
        require(msg.sender == owner);
